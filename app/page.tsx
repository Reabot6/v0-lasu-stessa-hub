...
export default function Home() {
  ...
  return (
    ...
    < section className = "relative bg-primary text-primary-foreground overflow-hidden min-h-[60vh] flex items-center" >
      ...
      < div className = "absolute inset-0 z-0" >
        {/* Optional: faint background image (replace src with a real LASU campus photo if you have one) */ }
        < div className = "absolute inset-0 bg-gradient-to-br from-primary via-primary/90 to-primary/70" /> {/* Dark overlay for contrast */ }

  {/* Large repeated/centered motto text as watermark */ }
  ...
  {/* Optional: smaller repeated version for texture */ }
